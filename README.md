# I2A OpenAPI Specification
[![Build Status](https://travis-ci.org/benoitbac/Redoc.svg?branch=master)](https://travis-ci.org/benoitbac/Redoc)
...
6. If you did everything correct, https://benoitbac.github.io/Redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://benoitbac.github.io/Redoc/
- SwaggerUI: https://benoitbac.github.io/Redoc/swagger-ui/
- Look full spec:
    + JSON https://benoitbac.github.io/Redoc/swagger.json
    + YAML https://benoitbac.github.io/Redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://benoitbac.github.io/Redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://benoitbac.github.io/Redoc/ with url from the message: `Server started <url>`
